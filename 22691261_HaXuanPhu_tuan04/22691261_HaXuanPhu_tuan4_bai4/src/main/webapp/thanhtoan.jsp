    ...
    <header
        ...
        <ul class="nav nav-pills">
            ...
            <c:if test="${not empty sessionScope.cart}">
                <li class="nav-item"><a href="giohang.jsp"
    ...
    <main>
        <div class="row gx-5">
            ...
            <div class="col-8 border border-2 pt-2">
                    ...
                    <div class="mb-3 row">
                        <label for="fullname" class="col-sm-2 col-form-label">Họ va tên:</label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        <label for="shippingAddress" class="col-sm-2 col-form-label">Địa chỉ
                            </label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        <label for="totalPrice" class="col-sm-2 col-form-label">Tổng giá trị</label>
                        <div class="col-sm-10">
